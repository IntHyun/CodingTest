...
// 입력 : 첫 줄에는 날짜의 일의 자리 숫자가 주어지고 두 번째 줄에는 7대의 자동차 번호의 끝 두 자리가주어진다.
...
// 강의 코드
// 어떤 숫자가 되었건간에 10으로 나눈숫자는 맨끝자리가 나머지가 됨.
function solution2(n, cars) {
  let answer = 0;
  for (const item of cars) {
    if (item % 10 === n) answer++;
  }
